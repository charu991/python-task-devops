...
const TextSpan = styled.span`
  ...
  color: #6F7182;
`
export default function SingleDisputeGlobal() {
    ...
    const getDisputeById = () => {
        axios.get(API_URLs.getDisputeId(param.id), {
            headers: {
                accept: "application/json",
                Authorization: `Bearer ${localStorage.getItem("userToken")}`,
            },
    ...
    return (
        <div className='p-3'>
            ...
            <div className="d-flex flex-column justify-content-between gap-3 align-items-start flex-md-row">
                <div
                ...
                >
                    ...
                    <div className="d-flex gap-2 align-items-center">
                        ...
                        <div className="w-25">
                            {singleDisputeData?.status === 'In-Progress' ?
                                <p className="mb-0 fw-bold text-warning">In-Progress</p>
                                : singleDisputeData?.status === 'Pending' ?
                    ...
                    {singleDisputeData?.solution &&
                        <div className="d-flex gap-2">
                            ...
                            <div>{singleDisputeData?.solution}</div>
                        </div>}
                    <div className="d-flex gap-2">
                        <div className="w-25">Dispute Category : </div>
                        <div>{singleDisputeData?.category}</div>
                    </div>
                    <div className="d-flex gap-2">
